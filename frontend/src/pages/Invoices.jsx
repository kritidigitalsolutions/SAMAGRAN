...
//               className="bg-white text-[#1a1a1a] rounded-2xl p-6 shadow-sm border border-gray-200"
//               style={{ fontFamily: "'Segoe UI', Arial, sans-serif", width: "100%", maxWidth: "900px", margin: "0 auto" }}
//             >
