                  ...
                  <tr key={pandit._id} className="border-b border-[#f0e3d1] align-top last:border-none dark:border-white/10">
                    ...
                    <td className="px-4 py-3">
                      <select
                        ...
                        className="h-9 min-w-[130px] rounded-lg border border-[#d7c3a3] bg-white/75 px-2 text-xs outline-none dark:border-white/10 dark:bg-[#23272e] dark:text-white"
                      >
                        {statusOptions.map((status) => (
                          <option key={status} value={status}>{status}</option>
                        ))}
        ...
        <div className="fixed inset-0 z-50 grid place-items-center  bg-black/45 p-4">
          <div className="w-full h-[90vh] max-w-2xl rounded-3xl border overflow-y-scroll border-[#dbc7a8]/60 bg-[var(--admin-surface)] p-6 shadow-[0_24px_70px_rgba(59,13,20,0.24)] dark:border-white/10 dark:bg-[var(--admin-surface)]">
            ...
            <div className="grid gap-3 text-sm md:grid-cols-2">
              ...
              <div className="rounded-xl bg-white/60 px-4 py-3 dark:bg-white/5"><span className="block text-xs opacity-70">Verified</span><strong>{selectedPandit.isVerified ? "Yes" : "No"}</strong></div>
